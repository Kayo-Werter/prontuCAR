...
const EditarAbastecimento = () => {
  ...
  const handleChange = (value: string | undefined, name?: string) => {
    const parsedValue = value === undefined ? undefined : parseFloat(value);
      ...
      <form onSubmit={handleSubmit} className="space-y-2 w-full max-w-md">
        <div>
          ...
          <CurrencyInput
            id="price_gasoline"
            name="price_gasoline"
            value={formData.price_gasoline?.toString() ?? ''}
            decimalsLimit={2}
            decimalSeparator=","
            groupSeparator="."
            prefix="R$ "
        ...
        <div>
          ...
          <CurrencyInput
            id="value_total"
            name="value_total"
            value={formData.value_total?.toString() ?? ''}
            decimalsLimit={2}
            decimalSeparator=","
            groupSeparator="."
            prefix="R$ "
        ...
        <div>
          ...
          <input
            ...
            name="refuel_date"
            value={formData.refuel_date}
            onChange={(e) => handleChange(e.target.value, 'refuel_date')}
            className="w-full p-2 border rounded"
            required
          />
        </div>
