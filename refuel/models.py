...
class Refuel(models.Model):
    ...
    price_gasoline = models.DecimalField(validators=[MinValueValidator(0, 'Avaliação não pode ser inferior a 0')], 
                                         max_digits=20, decimal_places=2)
    value_total = models.DecimalField(validators=[MinValueValidator(0, 'Avaliação não pode ser inferior a 0')], 
                                      max_digits=20, decimal_places=2)
